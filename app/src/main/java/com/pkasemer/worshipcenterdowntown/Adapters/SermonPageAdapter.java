...
public class SermonPageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<AllSermon> homeFeeds;
    ...
    public SermonPageAdapter(Context context, PaginationAdapterCallback callback) {
        this.context = context;
        this.mCallback = callback;
        homeFeeds = new ArrayList<>();
    }

    public List<AllSermon> getMovies() {
        return homeFeeds;
    }

    public void setMovies(List<AllSermon> homeFeeds) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        AllSermon homeFeed = homeFeeds.get(position); // Movie
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                SermonPageListAdapter adapter = new SermonPageListAdapter(context, homeFeed.getHomeSermons());
...
//                Do nothing
    ...
    */
    ...
    public void add(AllSermon r) {
        homeFeeds.add(r);
        notifyItemInserted(homeFeeds.size() - 1);
    }

    public void addAll(List<AllSermon> moveSelectedCategoryMenuItemResults) {
        for (AllSermon selectedCategoryMenuItemResult : moveSelectedCategoryMenuItemResults) {
            add(selectedCategoryMenuItemResult);
        }
    }

    public void remove(AllSermon r) {
    ...
    public void removeLoadingFooter() {
        ...
        AllSermon selectedCategoryMenuItemResult = getItem(position);
    ...
    public AllSermon getItem(int position) {
