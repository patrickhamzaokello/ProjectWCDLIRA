...
public class SimiliarEventsAdapter extends RecyclerView.Adapter<SimiliarEventsAdapter.ItemViewHolder> {
    ...
    private final List<HomeEvent> products;
    ...
    public SimiliarEventsAdapter(Context context, List<HomeEvent> products) {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        final HomeEvent product = products.get(position);


        holder.home_sermon_title.setText(product.getEventtitle());
        holder.home_sermon_description.setText(html2text(product.getEventdescription()));
        holder.sermon_author.setText(product.getEventlocation());
        holder.sermon_verse.setText(product.getCdate());

        Glide
                .with(context)
                .load(BASE_URL_IMG + product.getEventimage())
        ...
        holder.sermon_banner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("selectedEventId", product.getEventid());
                i.putExtra("selectedEVentTitle", product.getEventtitle());
