...
public class SermonPageListAdapter extends RecyclerView.Adapter<SermonPageListAdapter.ItemViewHolder> {
    ...
    public SermonPageListAdapter(Context context, List<HomeSermon> products) {
