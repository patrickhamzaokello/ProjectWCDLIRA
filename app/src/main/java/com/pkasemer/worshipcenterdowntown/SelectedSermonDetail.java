...
public class SelectedSermonDetail extends AppCompatActivity  implements MenuDetailListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selected_sermon);
        ...
        apiService = ApiBase.getClient(SelectedSermonDetail.this).create(ApiService.class);
...
//                Log.i(TAG, "onResponse: " + (response.raw().cacheResponse() != null ? "Cache" : "Network"));
    ...
    private void showCategoryErrorView() {
        ...
        AlertDialog.Builder android = new AlertDialog.Builder(SelectedSermonDetail.this);
        ...
        android.setMessage("This Menu Category will be updated with great tastes soon, Stay Alert for Updates.")
                ...
                .setPositiveButton("Home", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //go to activity
                        Intent intent = new Intent(SelectedSermonDetail.this, RootActivity.class);
