...
import com.pkasemer.worshipcenterdowntown.Models.SelectedProduct;
...
public class MyMenuDetail extends AppCompatActivity implements MenuDetailListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiService = ApiBase.getClient(MyMenuDetail.this).create(ApiService.class);
...
//                Log.i(TAG, "onResponse: " + (response.raw().cacheResponse() != null ? "Cache" : "Network"));
    ...
    private Call<ProductDetail> callProductDetail() {
        return apiService.getMenuDetails(
                selectMenuId,
                selectCategoryId,
                currentPage
        );
